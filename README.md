...
<i>It's not very likely that there can be anything significantly new in the field of algorithms for parsing arithmetic expressions. It's hardly possible that something so simple can be new. However, I was googling and so far, I have found nothing similar to this!? I haven't found this method in the books about discrete math and algorithms!? No stack, no state machine, no Shunting-Yard, no anything in this algorithm! So, I'll consider it new, for a while...</i>
